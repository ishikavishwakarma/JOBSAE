      ...
      <Container>
        <div className="grid md:grid-cols-5 gap-12 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-base text-slate-600 dark:text-slate-400 font-medium">
        ...
        <div className="pt-5 border-t border-slate-200 dark:border-slate-800 text-base text-slate-500 dark:text-slate-400 flex flex-col sm:flex-row justify-between items-center gap-4">
